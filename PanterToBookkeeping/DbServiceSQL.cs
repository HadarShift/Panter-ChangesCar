...
public class DbServiceSQL
{
    ...
    OleDbConnection conn = new OleDbConnection("Provider=SQLNCLI11;Server=ALSQL;Database=Panter;Trusted_Connection = yes;Uid=albi;Pwd=Al5342");
    ...
    public DbServiceSQL()
    {
        ...
        conn = new OleDbConnection("Provider=SQLNCLI11;Server=ALSQL;Database=Panter;Trusted_Connection = yes;Uid=albi;Pwd=Al5342");
        //
   ...
   public DataTable executeSelectQueryNoParam(String _query)
        {
            ...
            using (OleDbConnection con = new OleDbConnection("Provider=SQLNCLI11;Server=ALSQL;Database=Panter;Trusted_Connection = yes;Uid=albi;Pwd=Al5342"))
            {
                con.Open();
